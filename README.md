...
Os PDFs são divididos em faixas de até 400 páginas e 45 MB sem rasterização ou perda de
qualidade. O cache e o último estágio ficam em `/data/analysis_runtime` quando o Space possui
